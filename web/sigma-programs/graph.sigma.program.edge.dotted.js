...
(function () {
  ...
  function patchDottedFragmentShader(source) {
    ...
    var injection = [
      ...
      "  float ajpcLineMask = 1.0 - smoothstep(ajpcDotRadius - ajpcDotFeather, ajpcDotRadius + ajpcDotFeather, ajpcDotDist);",
      ...
      "    float ajpcRadius = max(ajpcHalfThickness * 3.6, 5.2);",
      ...
      "    float ajpcPhotonAlpha = clamp(v_color.a * ajpcPhoton * 0.92, 0.0, 1.0);",
      ...
      "      vec3 ajpcPhotonRgb = mix(ajpcBaseRgb, vec3(0.92, 0.97, 1.0), 0.68);",
