...
function checkEntrypointsAndUsecases() {
  ...
  mustContain(deltaApply, /cityUsecaseCallEngineMethod\(\"runSubsetNoDampingPull\",\s*subsetNodeIds,\s*\{\s*include_links:\s*true,\s*ticks:\s*0\s*\}\)/m, "delta subset pull calls engine port with include_links=true and ticks=0");
