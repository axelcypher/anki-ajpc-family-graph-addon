...
def render_graph_html(_payload: dict[str, Any]) -> str:
    ...
    replacements = {
        ...
        "__GRAPH_SIGMA_PROGRAM_EDGE_CURVED_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.edge.curved.js"),
        "__GRAPH_SIGMA_PROGRAM_EDGE_DASHED_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.edge.dashed.js"),
        "__GRAPH_SIGMA_PROGRAM_EDGE_DOTTED_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.edge.dotted.js"),
        "__GRAPH_SIGMA_PROGRAM_NODE_NOTE_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.node.note.js"),
        "__GRAPH_SIGMA_PROGRAM_NODE_HUB_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.node.hub.js"),
        "__GRAPH_SIGMA_PROGRAM_EXTRA_CARDDOTS_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.extra.carddots.js"),
        "__GRAPH_SIGMA_PROGRAM_EXTRA_NODEFX_JS__": asset_url("adapters/engine/programs/graph.engine.sigma.program.extra.nodefx.js"),
        "__GRAPH_STATE_JS__": asset_url("adapters/city/state/graph.city.state.js"),
        ...
        "__GRAPH_ENGINE_GATEWAY_JS__": asset_url("adapters/engine/gateway/graph.engine.gateway.js"),
        "__GRAPH_ENGINE_JS__": asset_url("adapters/engine/runtime/graph.engine.main.js"),
        "__GRAPH_DATA_JS__": asset_url("adapters/engine/graphstore/graph.engine.data.graphology.js"),
        "__GRAPH_SOLVER_JS__": asset_url("adapters/engine/solver/graph.engine.solver.d3.js"),
        "__GRAPH_RENDERER_JS__": asset_url("adapters/engine/renderer/graph.engine.renderer.sigma.js"),
        "__GRAPH_UI_DEPTREE_JS__": asset_url("adapters/city/ui/graph.city.ui.deptree.js"),
        "__GRAPH_UI_DEBUG_JS__": asset_url("adapters/city/ui/graph.city.ui.debug.js"),
        "__GRAPH_UI_TOOLTIP_JS__": asset_url("adapters/city/ui/graph.city.ui.tooltip.js"),
